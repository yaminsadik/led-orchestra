...
//!
//! Phase 1: one ESP32 dev board drives one strip; this node *is* the whole
...
pub const NODE: NodeConfig = NodeConfig {
    node_id: 1,
    // ESP32-C3/C6 dev boards commonly expose GPIO2, but check your board's
    // pinout and change this to whatever pin your strip's DIN is wired to.
    led_gpio_pin: 2,
